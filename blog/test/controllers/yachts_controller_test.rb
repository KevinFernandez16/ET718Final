...
class YachtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create yacht" do
    assert_difference('Yacht.count') do
      post yachts_url, params: { yacht: { beam: @yacht.beam, designer: @yacht.designer, draft: @yacht.draft, fuel: @yacht.fuel, length: @yacht.length, name: @yacht.name } }
    end
  ...
  test "should update yacht" do
    patch yacht_url(@yacht), params: { yacht: { beam: @yacht.beam, designer: @yacht.designer, draft: @yacht.draft, fuel: @yacht.fuel, length: @yacht.length, name: @yacht.name } }
